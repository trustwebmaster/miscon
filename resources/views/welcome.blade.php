    ...
    <section id="registration" class="py-24 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
                @foreach([
                    ['type' => 'Students', 'price' => '45', 'features' => ['Full conference access', 'Accommodation (4 nights)', 'Meals included', 'Conference materials', 'Certificate']],
                    ['type' => 'Alumni', 'price' => '65', 'features' => ['Full conference access', 'Accommodation (4 nights)', 'Meals included', 'Conference materials', 'Certificate', 'Alumni networking']],
                ] as $plan)
                <div class="reveal {{ $loop->index === 1 ? 'animation-delay-200' : '' }}">
                    <div class="price-tag h-full hover:scale-105 transition-transform duration-300">
                        <div class="price-tag-inner flex flex-col">
                            <div class="text-center mb-8">
                                <span class="text-sm uppercase tracking-wider text-white/60">{{ $plan['type'] }}</span>
                            ...
                            <a href="https://wa.me/263782504742?text=Hello! I want to register for MISCON26 as {{ $plan['type'] }}" target="_blank" class="btn-primary w-full text-center ripple-effect">
