...
<div x-data="{ showPassword: false, showConfirmPassword: false }">
    ...
    <div class="text-center mb-8">
        <div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-pcm-purple/20 flex items-center justify-center">
        ...
        <p class="text-white/60 mt-2 text-sm">Create a new secure password for your account</p>
    </div>
